/* Variante aus PR #20 — Ein Klang-System: Kampf und UI werden hoerbar
   Quelle: Branch `routine/2026-08-11-audio-sfx`, Datei `js/audio.js`.
...
AudioLabor.registriere('pr-20', function (globalThis) {
