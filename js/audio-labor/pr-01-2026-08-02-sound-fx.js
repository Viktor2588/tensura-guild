/* Variante aus PR #1 — Sound-Effekte: synthetisierte Audio-Politur
   Quelle: Branch `routine/2026-08-02-sound-fx`, Datei `js/audio.js`.
...
AudioLabor.registriere('pr-01', function (globalThis) {
