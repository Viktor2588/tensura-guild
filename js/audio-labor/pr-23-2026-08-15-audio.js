/* Variante aus PR #23 — Klang-System: prozedurale SFX fuer Treffer, Tod, Sieg und UI
   Quelle: Branch `routine/2026-08-15-audio`, Datei `js/audio.js`.
...
AudioLabor.registriere('pr-23', function (globalThis) {
