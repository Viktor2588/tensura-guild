/* Variante aus PR #4 — Klang: prozedurale Toneffekte fuer Kampf und UI (Phase 62)
   Quelle: Branch `routine/2026-08-03-klang`, Datei `js/audio.js`.
...
AudioLabor.registriere('pr-04', function (globalThis) {
