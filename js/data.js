...
(function (root) {
  ...
  var GLOSSAR = {
    ...
    zustaende: {
      ...
      provokation: 'Bis zum nächsten eigenen Zug greifen ALLE Gegner diese Einheit an — auch wer sie noch nicht erreicht, läuft zu ihr. Nur Frontkämpfer provozieren, über die Bibliothek („Herausforderung") oder ihre eigene Defensivlinie.',
    ...
    begriffe: {
      reichweite: 'Reichweite und Schritte haengen an der Rolle, und zwar gegenlaeufig \u2014 wer kurz reicht, laeuft weiter: Frontlinie erreicht 1 Feld und laeuft 4, Verstaerker und Unterstuetzer erreichen 2 und laufen 3, Fernkampf und Magier erreichen 3 und laufen 2. Wer niemanden in Reichweite hat, LAEUFT heran und darf im selben Zug noch zuschlagen, wenn es dann reicht. Weil kurze Reichweite mehr Schritte bekommt, ist jede Rolle nach EINEM Zug Anmarsch im Gefecht \u2014 Reichweite entscheidet ueber die Lage im Kampf, nicht ueber die Eroeffnung.',
      kombination: 'Drei Zustandspaare reagieren aufeinander — sie sind der Grund, warum ein gemischter Bau mehr sein kann als die Summe seiner Teile. VERPUFFUNG: Brand auf Gift, zusammen mindestens 8 Stapel — beide verbrennen und richten je Stapel 3 Schaden an, der durch Schilde geht. SPLITTER: Erstarrung auf einen mit Donner geladenen Gegner entlädt die Ladung sofort, statt auf die Schwelle zu warten. AUFGERISSEN: Blutung auf ein Ziel mit mindestens 3 Verwundbar fällt 50 % größer aus. Alle drei haben eine Schwelle, ein reiner Ein-Schlüsselwort-Bau löst sie also nie aus.',
      ...
      namensweihe: 'Ein Rangaufstieg unter dem regulären Preis, samt einer festen Passive — aber NICHT für eine Einheit deiner Wahl. Ziel und Passive werden beim Aufbau des Markts ausgelost und stehen im Angebot, du siehst also vorher genau, was du bekommst. Danach gibt es keine zweite Wahl mehr: ein Klick, eine Entscheidung. Der Preis hängt am Rang des Ziels. Ist das Ziel verkauft, verfällt der Posten.',
      ...
      rang: 'C \u2192 B \u2192 A \u2192 S. Jede Stufe gibt +30 % Leben und Angriff, einen Item-Slot (S: zwei), eine Passive mehr und einen Pr\u00e4dator-Slot; die aktive F\u00e4higkeit bleibt immer die Signatur. R\u00e4nge werden NICHT gekauft: Einheiten stehen im Markt schon auf ihrem Rang, mit so vielen Passiven, wie dazugeh\u00f6ren (C 1, B 2, A 3, S 4) \u2014 die Passiven gew\u00fcrfelt. Welche R\u00c4NGE der Markt zeigt, h\u00e4ngt am Fortschritt \u2014 und es sind immer nur zwei benachbarte: am Anfang 70 % C und 30 % B, kurz danach fast nur B, in der Mitte B und A, im Endspiel 85 % A und 15 % S. S bleibt also auch am Ende selten \u2014 vor dem Endspiel kommt es gar nicht vor, dort steht in etwa jedem zweiten Markt eines. Ein C-Posten im Endspiel w\u00e4re ein toter Posten, den gibt es nicht. Elite und Boss schieben das Fenster eine Stufe nach oben, dort ist die Chance auf ein S am h\u00f6chsten. Aufwerten hei\u00dft, eine bessere Fassung derselben Einheit zu kaufen: sie ersetzt die alte, deren ganzer Einsatz angerechnet wird; ihre Passiven bleiben, die neuen Pl\u00e4tze w\u00e4hlst du nach dem Kauf. Ein Gratisaufstieg kommt nur noch aus dem Lager. Nur EINE Einheit darf Rang S tragen \u2014 der Anf\u00fchrer. Steht er, bietet der Markt kein zweites S an, und keine andere Einheit steigt dorthin auf.',
      ...
      rolle: 'Bestimmt, wen die Einheit im Kampf angreift — Front das Nächste, Fernkampf die Hinterreihe, Magier das schwächste Ziel. Die einzige Ausnahme ist Spott.',
      ...
      spott: 'Deckung greift NACH dem Schlag — Spott davor, an der Zielwahl selbst. Wer Spott trägt, zieht jeden Angriff mit der angegebenen Wahrscheinlichkeit auf sich, egal welche Rolle der Angreifer hat und wen er eigentlich nehmen wollte. Es ist eine Chance, kein Zwang: der Rest der Angriffe geht weiter nach Rolle, ein Panzer schaltet die gegnerische Zielwahl also nicht ab. Auch wer noch nicht heranreicht, läuft auf den Spotter zu. Zwei Passiven legen ihn an: Gerudos „Alles auf mich" (50 %) und „Der letzte Wall" des Echsenfürsten (35 %) — beide bezahlen ihn mit ihrem Angriff, und beide bringen eine Haut mit, weil Ziehen ohne Zähigkeit nur schneller stirbt.',
