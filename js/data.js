...
(function (root) {
  ...
  var units = [
    ...
    u('riesenameise', 'Riesenameise', 'insektoid', 'front', 1, 70, 7, 4, 20,
      'sig_riesenameise', ['rachsucht', 'dornenhaut', 'schildwall']),
    ...
    u('skelettritter', 'Skelettritter', 'untot', 'front', 1, 65, 8, 4, 22,
      'sig_skelettritter', ['dornenhaut', 'wiederkehr', 'erstschlag']),
