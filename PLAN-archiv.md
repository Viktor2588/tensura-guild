# Tensura Guild — Plan-Archiv

Die ausführlichen Phasenprotokolle bis einschließlich Phase 77, ausgelagert aus
`PLAN.md` in Phase 92. Inhaltlich unverändert. Neue Phasen stehen in `PLAN.md`.
