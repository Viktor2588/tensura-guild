...
/* js/audio.js ist absichtlich dabei: jsdom kennt kein AudioContext, also
   bleibt `Klang.verfuegbar()` falsch und jeder Aufruf ist ein No-Op — genau
   der Fall, den `unterstuetzt()` abfaengt, statt ui.js mit einem Fehlen von
   `Klang` abstuerzen zu lassen. */
['js/rng.js', 'js/hex.js', 'js/fx.js', 'js/audio.js', 'js/brett3d.js', 'js/abilities.js', 'js/data.js', 'js/combat.js', 'js/enemies.js',
